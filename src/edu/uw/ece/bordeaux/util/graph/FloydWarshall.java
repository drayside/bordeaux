...
/*************************************************************************
 * Compilation: javac FloydWarshall.java Execution: java FloydWarshall V E
 ...
 *
 * Should check for negative cycles during triple loop; otherwise intermediate
 * numbers can get exponentially large. Reference:
 * "The Floyd-Warshall algorithm on graphs with negative cycles" by Stefan
 * Hougardy
 *
 *************************************************************************/
...
public class FloydWarshall {
	...
	private DirectedEdge[][] edgeTo; // edgeTo[v][w] = last edge on shortest v->w
																	 // path
	...
	public static void main(String[] args) {
		...
		for (int v = 0; v < G.V(); v++) {
			...
			for (int w = 0; w < G.V(); w++) {
				if (spt.hasPath(v, w))
					System.out.printf("%6.2f ", spt.dist(v, w));
				else
