...
public class EdgeWeightedDigraph {
	...
	public EdgeWeightedDigraph(In in) {
		...
		for (int i = 0; i < E; i++) {
			...
			if (w < 0 || w >= V)
				throw new IndexOutOfBoundsException(
						"vertex " + w + " is not between 0 and " + (V - 1));
	...
	/**
	 * Returns the number of directed edges incident from vertex <tt>v</tt>. This
	 * is known as the <em>outdegree</em> of vertex <tt>v</tt>.
	 * 
