...
check /*Closure*/assert1 for 5 but 7 State expect 0

run {all s : State - so/last | SpanTreeAtState[s]} for 5 but 7 State expect 0
run {all s : State - so/last | (s.parent = so/next[s].parent)} for 5 but 7 State expect 0
