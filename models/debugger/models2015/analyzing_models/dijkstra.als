...
run {GrabOrRelease} for 5 State, 5 Process, 4 Mutex expect 0
run {! Deadlock} for 5 State, 5 Process, 4 Mutex expect 0

check assert1 for 5 State, 5 Process, 4 Mutex expect 0
