...
check /*TypeSoundness*/assert1 for 3 expect 0

check /*TypeSoundness*/assert1 for 2 State, 1 Assignment,
1 Statement, 5 Interface, 5 Class, 1 Null,
7 Object, 12 Expr, 3 Field, 3 Slot expect 0

run{  all s, s': State, stmt: Setter |
    {RuntimeTypesOK[s]
    ExecuteSetter [s, s', stmt]
    TypeChecksSetter[stmt]
    }}for 2 State, 1 Assignment,
1 Statement, 5 Interface, 5 Class, 1 Null,
7 Object, 12 Expr, 3 Field, 3 Slot expect 0

run{
  all s': State | RuntimeTypesOK[s']
}for 2 State, 1 Assignment,
1 Statement, 5 Interface, 5 Class, 1 Null,
7 Object, 12 Expr, 3 Field, 3 Slot expect 0
