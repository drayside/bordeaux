...
assert /*BelowToo*/assert1 { all m: Man | some n: Man | m.Above[n] }

check /*BelowToo*/assert1 for 2 expect 1

pred Geometry {no m: Man | m.floor = m.ceiling}


assert /*BelowToo'*/assert2 { Geometry => (all m: Man | some n: Man | m.Above[n]) }
check /*BelowToo'*/assert2 for 2 expect 0

run Geometry for 3 
check /*BelowToo'*/assert2 for 3 expect 1
...
assert /*BelowToo''*/assert3 { NoSharing => (all m: Man | some n: Man | m.Above[n]) }
check /*BelowToo''*/assert3 for 6 expect 0
run NoSharing for 10
check /*BelowToo''*/assert3 for 10 expect 0
