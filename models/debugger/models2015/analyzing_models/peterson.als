...
check /*Safety*/assert1 for 10 but 2 pid, 3 priority, 5 label_t expect 0

// this assertion is trivial because of the hack described above
check /*NotStuck*/assert2 for 10 but 2 pid, 3 priority, 5 label_t expect 0

//This trigers all teh facts
run {} for 10 but 2 pid, 3 priority, 5 label_t expect 0
