...
pred distinct_valid_WSs {
    all ws, ws1 : WS | (
ws.RoadSegments = ws1.RoadSegments and 
ws.RoadSegment_speedLimit = ws1.RoadSegment_speedLimit and 
ws.Drivers = ws1.Drivers and 
ws.MapObjects = ws1.MapObjects and 
ws.MapObject_position = ws1.MapObject_position and
 ws.MapObject_shape = ws1.MapObject_shape and 
ws.RoadObjects = ws1.RoadObjects and 
ws.RoadObject_acceleration = ws1.RoadObject_acceleration and 
ws.RoadObject_speed = ws1.RoadObject_speed and 
ws.Lanes = ws1.Lanes and 
ws.AutoSoftCars = ws1.AutoSoftCars and 
ws.AutoSoftCar_steerDirection = ws1.AutoSoftCar_steerDirection and 
ws.AutoSoftCar_ignition = ws1.AutoSoftCar_ignition and 
ws.Drivess = ws1.Drivess and 
ws.Drives_r1 = ws1.Drives_r1 and 
ws.Drives_r2 = ws1.Drives_r2 and 
ws.IsOns = ws1.IsOns and 
ws.IsOn_r1 = ws1.IsOn_r1 and 
ws.IsOn_r2 = ws1.IsOn_r2 and 
ws.AutoSofts = ws1.AutoSofts and 
ws.BDSs = ws1.BDSs and 
ws.CCs = ws1.CCs and 
ws.CC_goalAccel = ws1.CC_goalAccel and 
ws.CC_cruiseSpeed = ws1.CC_cruiseSpeed and 
ws.HCs = ws1.HCs and 
ws.HC_headway = ws1.HC_headway and 
ws.HPs = ws1.HPs and 
ws.FCAs = ws1.FCAs and 
ws.FCA_alertLevel = ws1.FCA_alertLevel and 
ws.SLCs = ws1.SLCs) implies ws = ws1  
    all ws : WS | WSC [ws]
}
/*
...
pred p[]{not  AutoSoft_BDS_main_on_steering_t5_AND_AutoSoft_BDS_main_on_CC_main_enabled_main_engaged_main_t6
}
...
pred AutoSoft_BDS_main_on_acceleration_t3_AND_AutoSoft_BDS_main_on_steering_t5 {
...
pred AutoSoft_BDS_main_on_acceleration_t3_AND_AutoSoft_BDS_main_on_CC_main_t1 {
    distinct_valid_WSs implies
    all wsPre : WS |
...
pred AutoSoft_BDS_main_on_acceleration_t3_AND_AutoSoft_BDS_main_on_CC_main_t2 {
    distinct_valid_WSs implies
    all wsPre : WS |
...
pred AutoSoft_BDS_main_on_acceleration_t3_AND_AutoSoft_BDS_main_on_CC_main_enabled_main_engaged_main_t8 {
    distinct_valid_WSs implies
    all wsPre : WS |
...
pred AutoSoft_BDS_main_on_steering_t5_AND_AutoSoft_BDS_main_on_CC_main_enabled_main_engaged_main_t6 {
    distinct_valid_WSs implies
    all wsPre : WS |
...
pred AutoSoft_BDS_main_on_steering_t5_AND_AutoSoft_BDS_main_on_CC_main_enabled_main_engaged_main_t7 {
    distinct_valid_WSs implies
    all wsPre : WS |
...
pred AutoSoft_BDS_main_on_CC_main_FCA_main_active_setFCALevel_t4_AND_AutoSoft_BDS_main_on_CC_main_enabled_main_SLC_main_t3 {
    distinct_valid_WSs implies
    all wsPre : WS |
...
pred WSC_AutoSoft_BDS_main_on_CC_main_enabled_main_SLC_main_t2 {
    distinct_valid_WSs implies
    all wsPre : WS |
    some wsPost : {ws : WS - wsPre | WSTC [wsPre, ws]} |
